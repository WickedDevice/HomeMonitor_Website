  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sensor as @sensor" do
        ...
        post :create, {:sensor => { "device_id" => "invalid value" }}, valid_session
        assigns(:sensor).should be_a_new(Sensor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sensor" do
        ...
        Sensor.any_instance.should_receive(:update).with({ "device_id" => "MyString" })
        put :update, {:id => sensor.to_param, :sensor => { "device_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sensor as @sensor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sensor.any_instance.stub(:save).and_return(false)
        put :update, {:id => sensor.to_param, :sensor => { "device_id" => "invalid value" }}, valid_session
        assigns(:sensor).should eq(sensor)
      end
